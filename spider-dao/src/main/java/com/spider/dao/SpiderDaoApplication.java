...
import com.spider.dao.model.BaseHouseInfo;
...
public class SpiderDaoApplication implements CommandLineRunner {
    @Autowired
    private BaseHouseInfoMapper<BaseHouseInfo> baseHouseInfoMapper;

    @Autowired
    private HouseContentMapper<HouseContent> houseContentHouseContentMapper;
